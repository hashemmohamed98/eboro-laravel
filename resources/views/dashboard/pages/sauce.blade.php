        ...
        <!-- End Navbar -->
            <section class="position-relative main-content sm-content">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h2 class="main-color font-bold">{{trans('dashboard.sauce.sauce')}}</h2>
                    <div class="menu-btn">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2">
                        <div class="mt-2 text-right">
                            ...
                            <span class="text-black">{{trans('dashboard.beverages.price')}}</span></div>
                    </div>
                </div>
                <div class="row my-3 scroll-ele card-height">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-3 eboro-box">
                            ...
                            <div class="bg-white card-box-shadow border-radius-20 px-4 py-3 position-relative mb-4">
                                ...
                                <div class="text-center font-bold mt-3">
                                    ...
                                    @elseif(!empty($item))
                                        <div>{{$item->has_outofstock == 1 ? trans('admin.has_outofstock') : ($item->price??0).' €'}} </div>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="product_type" class="form-control radius" required>
                                    <option value="Sauce">Extra</option>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
